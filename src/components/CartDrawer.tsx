    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="font-serif text-2xl font-light">আপনার কার্ট</SheetTitle>
          <SheetDescription>
            {totalItems === 0 ? "আপনার কার্ট খালি" : `${totalItems} টি পণ্য`}
          </SheetDescription>
        </SheetHeader>
          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">কার্টে কিছু নেই</p>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border bg-background">
                <div className="flex justify-between items-center">
                  <span className="text-base font-medium">মোট</span>
